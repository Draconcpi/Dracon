      ...
      <AnimatePresence>
        {selectedItem && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-dracon-void/90 backdrop-blur-sm"
          ...
          >
            ...
            >
              {/* Image area */}
              <div className="aspect-[16/9] rounded-t-2xl relative overflow-hidden">
